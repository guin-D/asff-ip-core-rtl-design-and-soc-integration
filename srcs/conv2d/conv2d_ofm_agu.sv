...
module conv2d_ofm_agu #(
    ...
    output wire [WEIGHT_ADDR_WIDTH-1:0]         ofm_addr_o
);
    ...
    wire [DATA_ADDR_WIDTH-1:0] next_ofm_addr;

    assign next_ofm_addr = ofm_addr_o + 1;
    ...
    register #(
        ...
        .clk(clk),
        .rst_n(rst_n),
        .en(valid_i | thread_max), 
        .d(thread_max ? {DATA_ADDR_WIDTH{1'b0}} : next_ofm_addr),
        .q(ofm_addr_o)
    );
